...
#create an index file using samtools for the reference genome 'lyrata.fasta.fa'
...
#moving picard.jar to GATK directory
...
#nfiltering the VCF file using GATK 'select varients' tool to create seperate VCFs for each sample
